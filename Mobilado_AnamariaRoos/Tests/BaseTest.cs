...
namespace Mobilado_AnamariaRoos.Tests
{
    public class BaseTest
    {
        ...
        protected static string accountUrlPath = "inregistrare";
        protected static string livingUrlPath = "mobilier-decoratiuni-living-2";
        protected static string cartUrlPath = "cos-de-cumparaturi";
        ...
        protected void ExtentStart()
        {
            ...
            _extent.AddSystemInfo("Username", "Anamaria R");
        ...
        public void Setup()
        {
            ...
            driver.Value = Mobilado_AnamariaRoos.Utils.Browser.GetDriver();
                ...
                case NUnit.Framework.Interfaces.TestStatus.Failed:
                    {
                        ...
                        var screenshotEntity = Utilities.CaptureScreenShot(_driver, filename);
                ...
                case NUnit.Framework.Interfaces.TestStatus.Passed:
                    {
                        ...
                        _test.Pass("Test passed: ", Utilities.CaptureScreenShot(_driver, filename));
                        break;
                    }
